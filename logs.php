<?php
//HELLO, this is a place where I migrated most of the logs from index.php to make it more comprehensible because they were taking up too much space.
//This is kinda like an easter egg where it just doesn't even get used anywhere and even if you somehow manage to find it then nothing gets displayed to the user.
